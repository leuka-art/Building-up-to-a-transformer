...
I implemented a range of different optimisers and explored how they compare with each other on the image data set classification.

I implemented:
- Momentum, RMSProp, Adagrad, Adadelta and Adam using an optimiser class
- The class stores the hyperparameters and parameters of the model and has methods to update and zero grads
