...
- How non-linearity makes the loss landscape non-convex
...
I learned: 
- Residual connections are what make deep(er) transformer training tractable at all by giving gradients a direct path backward
- Layer normalisation primarily aids optimisation stability rather than model capacity
- Self-attention has no inherent notion of token order — positional embeddings are what supply it.
